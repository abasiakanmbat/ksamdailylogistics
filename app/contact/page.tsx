          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      General: info@ksamdaylogistics.com<br />
                      Sales: sales@ksamdaylogistics.com<br />
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-blue-100 rounded-full w-10 h-10 flex items-center justify-center hover:bg-blue-200 transition-colors">
