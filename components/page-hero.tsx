...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden hero-mesh">
      ...
      <div className="container-shell relative z-10 py-20 sm:py-24 lg:py-28">
              ...
              <div className="rounded-[30px] border border-white/10 bg-[#0b1630]/90 p-6">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-[28px] border border-white/6 bg-white/6 p-6">
                    ...
                    <p className="mt-4 text-sm leading-6 text-slate-300">Quick local collection for urgent documents and parcels.</p>
                  </div>
                  ...
                  <div className="rounded-[28px] border border-[#7ed38a]/10 bg-[#112539] p-6">
                    ...
                    <p className="mt-4 text-sm leading-6 text-slate-300">Clear movement updates from dispatch through final drop-off.</p>
                  </div>

                  <div className="rounded-[28px] border border-slate-200 bg-[#f8fafc] p-6 sm:col-span-2">
                    ...
                    <div className="mt-4 flex flex-wrap items-center gap-3 text-[#031020]">
                      <span className="rounded-full bg-[#e7f6ea] px-4 py-2 text-sm font-semibold text-[#236b33]">Bike delivery</span>
                      <span className="rounded-full bg-[#e7f6ea] px-4 py-2 text-sm font-semibold text-[#236b33]">Van delivery</span>
                      <span className="rounded-full bg-[#031020] px-4 py-2 text-sm font-semibold text-white">Truck delivery</span>
                    </div>
                    <p className="mt-5 max-w-lg text-base leading-7 text-slate-600">
                      Direct collection, careful handling, and the right vehicle for documents, parcels, fragile items, and larger consignments.
                    </p>
                  </div>
                </div>
              </div>
